...
function wpdt_load_replies( $ajaxCall ) {
	...
	foreach ($xml_replies->status as $replies) {
		...
		$replyoutput .= '<h4 class="wpdt-sender comment-meta">' . __( 'From', 'wp-dashboard-twitter' ) . ' <a href="http://twitter.com/' . urldecode( $replies->user->screen_name ) . '" class="url">' . wp_specialchars( $replies->user->screen_name ) . '</a> | <a href="' . urldecode( $replyurl ) . '" replytoname="' . $replies->user->screen_name . '" onclick="WPDashboardTwitter.reply(this, 0, ' . $replies->id . '); return false;" class="meta-reply" title="' . attribute_escape( __('Reply to a user', 'wp-dashboard-twitter') ) . '"><img src="' . WPDashboardTwitter_Helper::plugins_url('img/reply.png', __FILE__) . '" border="0" alt="' . attribute_escape( __('Reply', 'wp-dashboard-twitter') ) . '" /></a> <a href="#" onclick="WPDashboardTwitter.reply(this, 2, ' . $replies->id . '); return false;" title="' . attribute_escape( __('Retweet this message', 'wp-dashboard-twitter') ) . '"><img src="' . WPDashboardTwitter_Helper::plugins_url('img/retweet.png', __FILE__) . '" border="0" alt="' . attribute_escape( __('Retweet this message', 'wp-dashboard-twitter') ) . '" /></a></h4>';
...
function wpdt_load_timeline( $ajaxCall ) {
	...
	foreach ($xml_timeline->status as $timeline) {		
		...
		$timelineoutput .= '<h4 class="wpdt-sender comment-meta">' . __( 'From', 'wp-dashboard-twitter' ) . ' <a href="http://twitter.com/' . urldecode( $timeline->user->screen_name ) . '" class="url">' . wp_specialchars( $timeline->user->screen_name ) . '</a> | <a href="' . urldecode( $timelineurl ) . '" replytoname="' . $timeline->user->screen_name . '" onclick="WPDashboardTwitter.reply(this, 0, ' . $timeline->id . '); return false;" class="meta-reply" title="' . attribute_escape( __('Reply to a user', 'wp-dashboard-twitter') ) . '"><img src="' . WPDashboardTwitter_Helper::plugins_url('img/reply.png', __FILE__) . '" border="0" alt="' . attribute_escape( __('Reply', 'wp-dashboard-twitter') ) . '" /></a> <a href="#" onclick="WPDashboardTwitter.reply(this, 2, ' . $timeline->id . '); return false;" title="' . attribute_escape( __('Retweet this message', 'wp-dashboard-twitter') ) . '"><img src="' . WPDashboardTwitter_Helper::plugins_url('img/retweet.png', __FILE__) . '" border="0" alt="' . attribute_escape( __('Retweet this message', 'wp-dashboard-twitter') ) . '" /></a></h4>';
